function [output1,output2] = headerTemplateSss(input1,varargin)
% HEADERTEMPLATESSS - sss toolbox header template
% 
% Syntax:
%		output1				= HEADERTEMPLATESSS(input1)
%		output1				= HEADERTEMPLATESSS(input1,input2)
%		[output1,output2]	= HEADERTEMPLATESSS(input1,input2,Opts)
% 
% Description:
